...
class GLSimpleCameraRender(private val surfaceView: GLSurfaceView) : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        val vertexSrc = AssetUtils.loadShaderSrc(context, "camera_simple_vertex.glsl")
        val fragmentSrc = AssetUtils.loadShaderSrc(context, "camera_simple_frag.glsl")
