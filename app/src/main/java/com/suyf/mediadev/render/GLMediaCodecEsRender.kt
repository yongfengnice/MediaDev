...
class GLMediaCodecEsRender(private val surfaceView: GLSurfaceView) : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        val vertexSrc = AssetUtils.loadShaderSrc(context, "video_filter_vertex.glsl")
        val fragmentSrc = AssetUtils.loadShaderSrc(context, "video_filter_frag.glsl")
